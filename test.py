...
class SExpressionTest(unittest.TestCase):
    ...
    def test_simple_add(self):
        ...
        self.assertEqual(s_expression_calc.calc('(add 3 (add (add 3 3) 3))'), 12)
    ...
    def test_simple_multiply(self):
        ...
        self.assertEqual(s_expression_calc.calc('(multiply 2 (multiply 3 4))'), 24)
        self.assertEqual(s_expression_calc.calc('(multiply 3 (multiply (multiply 3 3) 3))'), 81)
    ...
    def test_nested_functions(self):
        ...
        self.assertEqual(s_expression_calc.calc('(multiply 2 (add (multiply 2 3) 8))'), 28)
